...
<template>
  <div class="max-w-4xl mx-auto no-select">
    ...
    <!-- PlatePal Tracker App Section -->
    <div class="mb-16 animate-fade-in">
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl">
        <div class="p-6 md:p-8">
          <div class="flex flex-col md:flex-row items-center">
            <div class="mb-6 md:mb-0 md:mr-8 flex justify-center">
              <img src="/icon.png" alt="PlatePal Tracker icon" class="w-24 h-24 md:w-32 md:h-32 rounded-2xl shadow-md transition-transform duration-300 transform hover:rotate-12" />
            </div>
            <div class="flex-1">
              <h2 class="text-2xl md:text-3xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-[#e384c7] to-[#9e6593]">
                {{ t('home.trackerProject.title') }}
              </h2>
              <p class="text-gray-600 dark:text-gray-300 mb-4">
                {{ t('home.trackerProject.description') }}
              </p>
              <div class="flex flex-wrap gap-2 mb-4">
                <span class="px-3 py-1 rounded-full text-sm font-medium bg-[#e384c7] bg-opacity-15 text-white">
                  {{ t('home.trackerProject.tags.openSource') }}
                </span>
                <span class="px-3 py-1 rounded-full text-sm font-medium bg-[#e384c7] bg-opacity-15 text-white">
                  {{ t('home.trackerProject.tags.calorie') }}
                </span>
                <span class="px-3 py-1 rounded-full text-sm font-medium bg-[#e384c7] bg-opacity-15 text-white">
                  {{ t('home.trackerProject.tags.react') }}
                </span>
              </div>
              <div class="flex space-x-3">
                <a 
                  href="https://github.com/MrLappes/platepal-tracker" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  class="px-4 py-2 rounded-md bg-gray-800 dark:bg-gray-700 text-white hover:bg-gray-700 dark:hover:bg-gray-600 transition-colors duration-200 flex items-center space-x-2"
                >
                ...
                <a 
                  href="/privacy" 
                  class="px-4 py-2 rounded-md bg-[#e384c7] text-white hover:bg-[#d16db3] transition-colors duration-200"
                >
                  {{ t('home.trackerProject.privacyButton') }}
                </a>
              </div>
            </div>
          </div>
